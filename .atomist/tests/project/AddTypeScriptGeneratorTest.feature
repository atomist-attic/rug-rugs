...
Feature: Tests from AddTypeScriptGenerator.rt
  ...
  Scenario: AddTypeScriptGenerator should add a new TypeScript generator even if no README
    Given a file named .atomist/manifest.yml for AddTypeScriptGenerator should add a new TypeScript generator even if no README
    Given a file named .atomist/package.json for AddTypeScriptGenerator should add a new TypeScript generator even if no README
  ...
  Scenario: AddTypeScriptGenerator should make no changes if no manifest.yml
    Given a file named .atomist/package.json for AddTypeScriptGenerator should make no changes if no manifest.yml
  ...
  Scenario: AddTypeScriptGenerator should add package.json if not preset
    Given a file named .atomist/manifest.yml for AddTypeScriptGenerator should add package.json if not preset
  ...
  Scenario: AddTypeScriptGenerator should fail if no generator name provided
    Given a file named .atomist/manifest.yml for AddTypeScriptGenerator should fail if no generator name provided
    Given a file named .atomist/package.json for AddTypeScriptGenerator should fail if no generator name provided
